...
function Para2() {
    ...
    justify-center -translate-y-1/5 ">
            <div className="text sm:w-[80%] flex flex-col items-center sm:items-end justify-center ">
                ...
                <h3 className='textpara2 sm:w-[40%] text-purple-600 font-[Sansita] text-[2.4vh] sm:text-[3.5vh] font-medium text-center tracking-wide leading-[5vh] mb-10'> Kunal is not just a friend but a constant source of inspiration. His dedication to his work and personal growth motivates everyone around him. He’s always there to lend a helping hand and share his wisdom.</h3>
                <div className="pers w-[40%] flex flex-col items-center justify-center gap-2">
                    ...
                    <h1 className='text-[2.8vh] sm:text-[3.8vh] font-medium'>Sam Shaw</h1>
                    <h3 className='text-zinc-500 text-[2.4vh] whitespace-nowrap'>SWE @Microsoft</h3>
                </div>
            </div>
        </div>
    )
