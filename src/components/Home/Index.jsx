import video from '../../assets/video/H1.mp4'
import Row from '../Row'
            ...
            <div className='w-full sticky top-0 left-0 '>
                    ...
                    <div className="w-full flex sm:flex items-center justify-between  mt-5">
                        <div className="hidden md:flex gap-2 items-start z-[9] cursor-pointer ">
                            {["Shruv"].map((item, index) => (
                                <h4 key={index} className={`${styles.links} h-[5vh] relative py[2.4vh] px-[2.2vh] text-center italic  flex flex-col
                            font-[Playwrite] text-[5vh] overflow-hidden font-medium leading-[5vh]   `}>
                ...
                <div className='btmtext absolute z-[4] bottom-[4%] left-[25%] text-center sm:text-start sm:bottom-[7%] sm:left-8 w-56 '>
                    <h1 className='sm:text-[2vh] font-semibold'>
                        ...
                        a small attempt to say how deeply
                ...
                >
                    ...
                    -translate-x-1/2 max-w-xs'
                    >
                        <h2 className='toptext text-[2.2vh] font-[Sansita] tracking-wide font-medium text-center'>Every moment, in every breath, it’s always about us — forever intertwined</h2>
                    </div>
